...
export class RoleService {
  ...
  getRoles(roleTypeId?:any): Observable<any>{
  ...
  DeleteRole(Id: number | null | undefined,
    userId: number | null | undefined
  ): Observable<any> {
    let url_ = AppConsts.apiUrl.deleteRole;
    if (Id !== undefined && Id !== null) {
      url_ += 'RoleId=' + encodeURIComponent('' + Id) + '&';
    }
  ...
  getLandingPagePaths(): Observable<any>{
    let url_ = AppConsts.apiUrl.getLandingPages;
    return this.http.get(url_, AppConsts.httpOptions)
  }
